...
export function ListarProyectos() {
    return (<Column.Group multiline centered style={{ width: '100%', textAlign: 'center',display: 'flex',justifyContent: 'space-between', alignItems:' stretch', margin: '0 0px 1em' }} breakpoint="mobile">
        {GetAllProyectos.map((item, i) => <Column key={i} size={4} ><Box component="span" m={1}> <Item  item={item} /></Box></Column>)}
        </Column.Group>
    )
}
